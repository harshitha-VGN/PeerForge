  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-[#14141a] p-6 rounded-2xl border border-[#2a2a38] flex items-center gap-4">
        ...
        <div>
          <div className="text-xs text-gray-500 uppercase tracking-widest font-bold">Current Streak</div>
      ...
      <div className="bg-[#14141a] p-6 rounded-2xl border border-[#2a2a38] flex items-center gap-4">
        ...
        <div>
          <div className="text-xs text-gray-500 uppercase tracking-widest font-bold">Focus Coins</div>
